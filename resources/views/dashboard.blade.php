    ...
    <div class="mbr-navbar__section mbr-section">
        <div class="mbr-section__container container">
            ...
            <div class="mbr-navbar__column mbr-navbar__menu">
                <nav class="mbr-navbar__menu-box mbr-navbar__menu-box--inline-middle">
                  <div class="mbr-navbar__column">
                    <ul class="mbr-navbar__items mbr-navbar__items--middle mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active">
...
<section>
    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-box__magnet--center-middle">
        <div class="mbr-overlay" style="opacity: .5; background-color: rgb(white);"></div>
      ...
      <div class="mbr-arrow mbr-arrow--floating text-center">
          <div class="mbr-section__container container">
            <a class="mbr-arrow__link" href="#features"><i class="glyphicon glyphicon-menu-down"></i></a>
...
<div class="content-section-a">
      <a name="features"></a>
    <div>
    <h1 style="text-align:center; text-color:white;">Welcome to my Dashboard...COOMING SOON</h1>
  </div>
    <div class="container">
...
<footer class="mbr-section mbr-section--relative mbr-section--fixed-size" id="footer1-91" style="background-color: rgb(68, 68, 68);">
    <div class="mbr-section__container container">
        <div class="mbr-footer mbr-footer--wysiwyg row">
            <div class="col-sm-12">
              <p class="mbr-footer__copyright"></p><p>Copyright (c) 2016 o2Meet. <a href="#" class="text-gray">License</a></p><p></p>
            </div>
        </div>
    </div>
</footer>
        ...
        <!-- Tab panes -->
             ...
             <div role="tabpanel" class="tab-pane" id="login-tab">
               <form action="/login" method="get">
                 <input type="email" class="form-control" id="fullname" name="fullname" placeholder="Enter E-mail">
